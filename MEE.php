...
<div class="container">
  <div class="row">
    <div class="col-12">
      ...
      <p class="card-text"><?php echo $rows3['About_Yourself'];?></p>
      

      <ul class="list-group list-group-flush">
    <li class="list-group-item"><p>Branch : <?php echo $rows2['Branch'];?></p></li>
    <li class="list-group-item"><p> Batch from: <?php echo $rows2['Batch _From'];?></p></li>
    <li class="list-group-item"><p> Batch To: <?php echo $rows2['Batch_To'];?></p></li>
    
    <li class="list-group-item"> <p> Employement Status: <?php echo $rows3['Employment_Status'];?></p></li>
